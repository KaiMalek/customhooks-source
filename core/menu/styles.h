...
void SetupStyles()
{
	...
	colors[ImGuiCol_Separator] = ImVec4(0.42f, 0.07f, 1.00f, 1.00f);
	colors[ImGuiCol_SeparatorHovered] = ImVec4(0.42f, 0.07f, 1.00f, 1.00f);
	colors[ImGuiCol_SeparatorActive] = ImVec4(0.42f, 0.07f, 1.00f, 1.00f);
