...
bool ImGui::Checkbox(const char* label, bool* v, bool safe)
{
    ...
    if (*v)
        window->DrawList->AddRectFilledMultiColor(pos + ImVec2(2, 2), pos + ImVec2(10, 10), ImColor(variables::config::menu_color[0], variables::config::menu_color[1], variables::config::menu_color[2], g.Style.Alpha), ImColor(variables::config::menu_color[0], variables::config::menu_color[1], variables::config::menu_color[2], g.Style.Alpha), ImColor(30 / 255.f, 30 / 255.f, 30 / 255.f, g.Style.Alpha), ImColor(30 / 255.f, 30 / 255.f, 30 / 255.f, g.Style.Alpha));
